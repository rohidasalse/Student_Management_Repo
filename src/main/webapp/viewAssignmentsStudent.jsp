...
<div class="container mt-5">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editAssignment?title=<%= assignment.getTitle() %>" class="btn btn-sm btn-warning me-2">Upload Assignment</a>
    ...
    <div class="mt-4">
         <a href="studentLoginSuccess.jsp" class="btn btn-primary">Back to Dashboard</a>
    </div>
</div>
